 ...
 * - Seoul Data Hub, "서울시 역코드로 지하철역별 열차 시간표정보 검색",
 *   https://data.seoul.go.kr/bsp/wgs/dataView/data300View/527.do: current official station-timetable
 *   interface for the Seoul-operated Line 3 segment. Row-level results require an API key, so
 *   Gupabal/Ogeum could not be independently extracted; no primary source contradicted them.
 * Accessed 2026-07-21.
 */
const seoul3 = [
...
export const LINES:Line[] = [
  { id:'seoul-1', name:'서울 1호선', color:'#0052A4', sequences:[s1North,s1Incheon,s1Sinchang], serviceTermini:['소요산','인천','신창'].map(station=>({station,source:korailSource})) },
  ...
  { id:'seoul-3', name:'서울 3호선', color:'#EF7C1C', sequences:[seoul3], serviceTermini:['대화','구파발','삼송','오금'].map(station=>({station,source:'https://data.seoul.go.kr/bsp/wgs/dataView/data300View/527.do'})) },
